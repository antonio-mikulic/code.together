...
{
    public abstract class TogetherWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TogetherWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TogetherWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TogetherDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TogetherDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TogetherDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TogetherDbContext, Task<T>> func)
        {
            T result;
